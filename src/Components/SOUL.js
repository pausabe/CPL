...
export default class SOUL {
  constructor(props, HS) {
    ...
    //taula 1 (#2): Ofici(1)
    if(props.LT !== GLOBAL.Q_TRIDU && props.LT !== GLOBAL.P_OCTAVA && props.LT !== GLOBAL.N_OCTAVA){
      c += 1;
    ...
    if(props.LT === GLOBAL.Q_CENDRA || props.LT === GLOBAL.Q_SETMANES){
      c += 1;
      id = 1;
    ...
    if(props.LT === GLOBAL.Q_DIUM_RAMS || props.LT === GLOBAL.Q_SET_SANTA){
      c += 1;
      id = 1;
    ...
    if(props.LT === GLOBAL.Q_DIUM_RAMS){
      c += 1;
      id = 1;
    ...
    if(props.LT === GLOBAL.Q_SET_SANTA){
      c += 1;
    ...
    if(props.LT === GLOBAL.P_OCTAVA || props.LT === GLOBAL.P_SETMANES){
      c += 1;
      id = 1;
    ...
    if(props.LT === GLOBAL.A_SETMANES || props.LT === GLOBAL.A_FERIES || props.LT === GLOBAL.N_OCTAVA || props.LT === GLOBAL.N_ABANS){
      c += 1;
      switch (props.LT) {
    ...
    if(props.LT === GLOBAL.A_SETMANES || props.LT === GLOBAL.A_FERIES){
      c += 1;
      id = props.cicle;
